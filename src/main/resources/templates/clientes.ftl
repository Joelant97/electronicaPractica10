...
<section class="body">
    ...
    <div class="inner-wrapper">
        ...
        <section role="main" class="content-body">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <form id="form" action="/clientes/add/" class="form-bordered" method="post" enctype="multipart/form-data">
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">Nombre Completo <span
                                                class="required">*</span></label>
                                    <div class="col-sm-6">
                                        <input type="text" name="fullname" class="form-control"
                                               placeholder="eg.: John Givez" required/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="cedula" class="form-control"
                                               placeholder="eg.: 03100000000" required/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">Telefono<span
                                                class="required">*</span></label>
                                    <div class="col-sm-6">
                                        <input type="text" name="telefono" class="form-control"
                                               placeholder="eg.: 8095817000" required/>
                                    </div>
                                </div>
                                <div class="form-group">
