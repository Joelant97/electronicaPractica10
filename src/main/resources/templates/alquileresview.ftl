            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="mb-md">
                                <a class="popup-with-form btn btn-primary" href="#alquiler-form">Agregar <i class="fa fa-plus"></i></a>
                            </div>
                        </div>
                        <!-- Equipos Form -->
                        <form id="alquiler-form" class="white-popup-block mfp-hide form-horizontal"
