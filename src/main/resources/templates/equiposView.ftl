                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <form id="equipo-form" class="white-popup-block mfp-hide form-horizontal"
                              action="/equipos/add/" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-sm-12">
                            ...
                            <div class="form-group mt-lg">
                                <label class="col-sm-3 control-label">Costo por dia</label>
                                <div class="col-sm-9">
                    ...
                    <table class="table table-bordered table-striped mb-none" id="datatable-editable">
                        ...
                        <tbody>
                                ...
                                <tr class="gradeX">
                                    ...
                                    <td>${equipo.getSubCategoria()!}</td>
                                    <td>${equipo.getExistencia()}</td>
                                    <td>${equipo.getCostoPorDia()}</td>
                                    <td class="actions">
                                        <a href="#" class="hidden on-editing save-row"><i class="fa fa-save"></i></a>
                                        <a href="#" class="hidden on-editing cancel-row"><i class="fa fa-times"></i></a>
                                        <a href="/edit/${equipo.getId()}" class="on-default edit-row"><i
